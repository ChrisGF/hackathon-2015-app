(function(){
  'use strict';
  angular.module('app')
    .factory('AccountsSrv', AccountsSrv);

  // This is a dummy service to use in demo...
  AccountsSrv.$inject = ['$http', '$q', '$timeout', 'Utils', 'Config', '_', 'StorageUtils'];
  function AccountsSrv($http, $q, $timeout, Utils, Config, _, StorageUtils){
